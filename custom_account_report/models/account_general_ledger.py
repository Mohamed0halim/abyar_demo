...
class AccountGeneralLedgerReport(models.AbstractModel):
        ...
        for account, periods_results in accounts_results:
            ...
            if has_lines and (unfold_all or is_unfolded):
                    ...
                    for aml in amls:
                        ...
                        lines.append(
                            self._get_aml_line(options, account, aml, company_currency.round(cumulated_balance)))
    ...
    def _get_tax_declaration_lines(self, options, journal_type, taxes_results):
        lines = [{
            ...
            'colspan': self.user_has_groups('base.group_multi_currency') and 3 or 2,
            'level': 2,
            'unfoldable': False,
            'unfolded': False,
        }]
        ...
        for tax_line in tax_report_lines:
            if tax_line['id'] not in ('sale', 'purchase'): # We want to exclude title lines here
                ...
                tax_line['colspan'] = self.user_has_groups('base.group_multi_currency') and 4 or 3
